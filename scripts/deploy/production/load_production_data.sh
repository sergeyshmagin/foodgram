...
echo "👤 Администратор должен быть создан с помощью команды create_admin_safe"
echo "   Команда: docker exec foodgram-backend python manage.py create_admin_safe"
echo ""
...
echo "   - Создайте администратора безопасным способом"
echo "   - Перейдите в админку по ссылке выше"
echo "   - Войдите под созданной учетной записью"
